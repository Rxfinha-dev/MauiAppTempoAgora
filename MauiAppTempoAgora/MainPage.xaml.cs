...
namespace MauiAppTempoAgora
{
    public partial class MainPage : ContentPage
    {
        ...
        private async void Button_Clicked(object sender, EventArgs e)
        {
            ...
            catch (FeatureNotSupportedException fneEx)
            {
                await DisplayAlert("Erro: Dispositivo não Suporta", fneEx.Message, "OK");
            }
            catch (FeatureNotEnabledException fneEx)
            {
                await DisplayAlert("Erro: Locazição Desabilitada", fneEx.Message, "OK");
